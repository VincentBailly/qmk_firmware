...
[BASE] = LAYOUT_split_3x5_3( \
   KC_Q,         KC_W,         KC_K,         KC_R,         KC_NO,             KC_Y,      KC_U,         KC_I,         KC_O,         KC_P, \
   LGUI_T(KC_J), LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G,             KC_H,      LSFT_T(KC_A), LCTL_T(KC_E), LALT_T(KC_L), LGUI_T(KC_SCLN), \
